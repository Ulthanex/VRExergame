...
namespace VRTK
{
    ...
    public class VRTK_MoveInPlace : MonoBehaviour
    {
        ...
        public DirectionalMethod directionMethod = DirectionalMethod.PositionRelativeToKinect;
        ...
        public float verticalMovementSmoothness = 0.1f;
        private KinectManager cameraManager;
        ...
        protected virtual Vector3 SetDirection()
        {
            ...
            else if (directionMethod.Equals(DirectionalMethod.PositionRelativeToKinect))
            {
